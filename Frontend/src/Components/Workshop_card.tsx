...
export default function CardWorkshop(porps: {title: string, date: string, description: string,link: string, setLoading: (loading: boolean) => void}) {
    ...
    <div key={evaluateYoutubeId(porps.link)}
      ...
      {modal && ( <div> 
        <div
          ...
          <div onClick={(e) => e.stopPropagation()} className="flex h-[75vh] w-[90vw] bg-slate-400 rounded-xl flex-row items-center relative">
                ...
                <div className="flex flex-col w-[30%] mt-2">
                  ...
                  <div className= "items-center justify-center flex flex-col mb-2 text-center">
                    <p> Escanea el siguiente código QR y disfruta del Workshop en tu dispositivo: </p>
